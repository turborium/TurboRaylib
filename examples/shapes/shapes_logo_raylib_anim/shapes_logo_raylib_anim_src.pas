...
*
********************************************************************************************)
unit shapes_logo_raylib_anim_src;
  ...
  begin
    ...
    BeginDrawing();
      ...
      begin
        ...
        DrawText(TextSubtext(UTF8String('raylib'), 0, LettersCount), GetScreenWidth() div 2 - 44, GetScreenHeight() div 2 + 48, 50, Fade(BLACK, Alpha));
      end
      else if State = 4 then
      begin
        DrawText(UTF8String('[R] REPLAY'), 340, 200, 20, GRAY);
      end;
