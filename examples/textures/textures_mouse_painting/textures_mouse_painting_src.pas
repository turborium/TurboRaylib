...
*
********************************************************************************************)
unit textures_mouse_painting_src;
...
begin
  ...
  InitWindow(ScreenWidth, ScreenHeight, UTF8String('raylib [textures] example - mouse painting'));
  ...
  BtnSaveRec := TRectangle.Create(750, 10, 40, 30);
  ...
  begin
    ...
    DrawRectangleLinesEx(TRectangle.Create(ColorsRecs[ColorSelected].X - 2, ColorsRecs[ColorSelected].Y - 2,
    ...
    if BtnSaveMouseHover then
      DrawText(UTF8String('SAVE!'), 755, 20, 10, RED)
    else
      DrawText(UTF8String('SAVE!'), 755, 20, 10, BLACK);
    ...
    begin
      ...
      DrawText(UTF8String('IMAGE SAVED:  my_amazing_texture_painting.png'), 150, 180, 20, RAYWHITE);
    end;
